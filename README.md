...
A NOMAD parser plugin for ECCI measurements in AddMorePower
...
```sh
git clone https://github.com/Guillaume-Gaisne/nomad-ECCI_parser.git
cd nomad-ECCI_parser
...
```sh
pip install dist/nomad-ECCI_parser-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Guillaume Gaisné | [guillame.gaisne@esrf.fr](mailto:guillame.gaisne@esrf.fr)
